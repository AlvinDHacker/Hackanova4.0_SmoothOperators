...
export interface ResQInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "beneficiaries"
...
export interface ResQ extends BaseContract {
  connect(runner?: ContractRunner | null): ResQ;
  waitForDeployment(): Promise<this>;

  interface: ResQInterface;
